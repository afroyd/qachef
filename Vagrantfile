...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "amir-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/zendqa"
  #   chef.validation_client_name = "zendqa-validator"
  #   chef.validation_key_path = ".chef/zendqa-validator.pem"
  # end
end
